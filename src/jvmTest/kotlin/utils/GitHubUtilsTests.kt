...
class GitHubUtilsTests : FunSpec({
    ...
    context("get branch name") {
        ...
        test("generated branch name should end with a unique identifier of length 40") {
            GitHubUtils.getBranchName(identifier, version) shouldMatch "^$identifier-$version-[A-Z0-9]{40}$"
        }
