...
A **fast, intelligent CLI** to create and submit [WinGet manifests](https://github.com/microsoft/winget-pkgs) — powered
by Rust.  
...
> komac needs a GitHub token to submit PRs to `winget-pkgs`.

Currently, it only works with a classic token:
...
Whilst Komac can fully create manifests and commit with a
...
## GitHub Actions: [WinGet Releaser](https://github.com/vedantmgoyal9/winget-releaser) 🌟
