...
pub struct InstallationNotes(Value<1, 10000>);
...
impl TypeName for InstallationNotes {
    const NAME: &'static str = "Installation notes";
}

#[cfg(test)]
mod tests {
    use crate::locale::installation_notes::InstallationNotes;
    use crate::shared::value::{ValueConstraints, ValueError};
